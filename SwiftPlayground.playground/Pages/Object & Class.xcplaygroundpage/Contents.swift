...
var nameShape1 = NamedShape(name: "Runner")
nameShape1.simpleDescription()
...
class EquilaterlTriangle: NamedShape {
    ...
    override func simpleDescription() -> String {
        return "An equilaterl triangle with sides of length \(sideLength)"
    }
}
...
//Everything after ? is “is ignored and the value of the whole expression is nil.
